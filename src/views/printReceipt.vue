<template>
  <div class="w-full bg-white p-10 h-full" >
    <div  v-for="printt in printData" :key="printt.id">
      ...
      <div class="flex">
        <p class="text-blue-500 font-medium text-xl">Receipt</p>
    ...
    <div class="flex justify-between mt-5">
      <div>
        <p class="text-blue-500 font-medium text-2xl">Paid By</p>
      ...
      <div class="flex">
        <p class="text-blue-500 font-medium text-xl">Receipt Date</p>
