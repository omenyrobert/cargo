  ...
  <div class="flex h-screen w-full bg-slate-100">
    ...
    <div class="w-full">
      ...
      >
        <form @submit.prevent="postInvoice">
          <div class="flex justify-between bg-gray-100 p-3">
            <div class="text-blue-500 font-bold">Add Invoice</div>
            <div>
          ...
          <div class="flex p-3">
            ...
            <div class="w-1/2">
              ...
              <button
                type="submit"
                class="text-white p-2 bg-blue-500 rounded-md w-3/4"
              >
                Add Invoice
              </button>
            </div>
      ...
      <div
        ...
        style="height: 90vh"
      >
    <p class="font-bold text-lg text-blue-500" >All Receipts</p>
