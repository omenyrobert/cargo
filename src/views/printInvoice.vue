<template>
  <div class="w-full bg-white p-10 h-full" >
    <div  v-for="printt in printData" :key="printt.id">
      ...
      <div class="flex">
        <p class="text-blue-500 font-medium text-xl">Invoice</p>
    ...
    <div class="flex justify-between mt-5">
      <div>
        <p class="text-blue-500 font-medium text-2xl">Billed To</p>
      ...
      <div>
        <p class="text-blue-500 font-medium text-2xl">Product</p>
        <p class="text-xl text-gray-700"> {{ printt.productTbl }}</p>
    
      </div>
      <div class="flex">
        <p class="text-blue-500 font-medium text-xl">Invoice Date</p>
    ...
    <div  class="mt-5 p-2 flex text-white bg-blue-500">
    ...
    <div  class="p-2 flex text-blue-500 bg-blue-100">
      <div class="w-1/4">Item</div>
      <div class="w-1/4"></div>
      <div class="w-1/4"></div>
